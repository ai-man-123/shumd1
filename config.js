...
global.namabot = 'lynxBotzシ' //nama BOT Lu
global.packname = 'lynxBotzシ'
global.author = 'lynxaiman' //nama Owner
global.ownernya = '60102810046'
global.linkyt = '-' //link yt lu
global.linkig = 'https://instagram.com/aiman1_23' //link ig
global.linkgh = '-' //link github lu
global.titlebot = `⫹⫺ WhatsApp Bot | By lynx`
global.wm2 = 'bruh' //ganti aja kalau mau
global.wm = 'lynxBotz'
global.colong1 = 'Ciss 📸'
global.colong2 = 'lynxBotzシ︎'
global.kontak2 = [
['60102810046', '𓂺', '𝙊𝙬𝙣𝙚𝙧', 'Sᴀᴠᴇ Aᴊᴀ Oᴡɴᴇʀ Kᴜ Bᴀɪᴋ Kᴏᴋ', true],
]

//Biodata OWNER Bre
global.RL = 'HAMBAH ALLAH' //Nama RL Lu
global.gender = 'Cowo/laki' //jenis kelamin lu
global.agama = 'islam' //agama lu
global.age = '15' //usia lu sekarang
global.kelas = '-' //kelas lu
global.hobi = 'game/turu/ngoding' //hobi lu bre
global.tempat = 'Asia , MALAYSIA' //tempat tinggal lu
