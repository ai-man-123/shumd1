...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args }) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'edukasi', 'news', 'random', 'convert', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'jadian', 'quran', 'fun', 'database','quran', 'vote', 'audio', 'info', 'owner', 'nocategory']
  ...
  try {
    ...
    let mpt = clockString(_mpt)
      const sections = [
   {
	title: `${htki} SUPPORT LYNX ${htka}`,
	rows: [
	    {title: `Ping`, rowId: ".ping", description: "Menampilkan ping bot"},
	    {title: `Owner`, rowId: ".owner", description: 'menampilkan owner yang terhensem:v'},
	]
	},{
...
const listMessage = {
  text: tek,
  footer: '📮 *Note:* Jika menemukan bug, error atau kesulitan dalam penggunaan silahkan laporkan/tanyakan kepada Owner Aiman',
